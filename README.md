...
【ai优化简历和招呼语存在bug（纯瞎编，包括说明明自己简历上没写的东西，但岗位要求了就硬编），也可能是我使用的模型太垃圾，不遵守指令规则。如需使用，建议手动上传招呼语/简历图片，等我再改改】
...
| **名校名册判定** | 内置 985+211+科技岗双一流院校名册，简历院校双向子串命中；简历院校**缺失时不误杀**（退回学历等级门槛） | 容忍「清华大学深圳研究院」「清华」等缩写限定，缺数据宁宽勿错杀 |
| **学历双档 / 下限** | 「大专或本科」取**下限**大专；「双一流以上学历（无学历词）」按**本科底线**，不当不限 | 最低能接受的学历才是门槛 |
| **双档经验按学历分流** | 「专科X年以上，本科Y年以上」按简历学历取对应档 | 本科候选人不再被更严的专科档误压分 |
| **子年经验解析** | 「半年 / 0.5年 / N个月 / 多年」正确解析为小数，不再回退裸数字错判成整数年 | 「0.5年」不能再被当成「5年」硬门槛 |
| **模糊经验语义化** | 「有相关经验」「多年」视作宽松门槛给满分，不再吃兜底 8 分 | 虚指经验不再误杀候选人 |
| **A/B、A或B 技能二选一** | 「MySQL/PostgreSQL」拆项后**命中任一即满足**，从缺技能清单剔除 | 「二选一」不再被当成「两样都要」 |
